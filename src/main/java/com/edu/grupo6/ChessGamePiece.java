...
public abstract class ChessGamePiece {
    ...
    public void setSkipMoveGeneration(boolean skip) {
        this.skipMoveGeneration = skip;
    }

    public void setPieceImage() {
        //if(this.pieceColor == 0 || this.pieceColor == 1) {
    ...
    public void setPossibleMoves(ChessGameBoard board) {
        if (this.board.getCell(pieceRow, pieceColumn) != null) {
            this.board.getCell(pieceRow, pieceColumn).setPieceOnSquare(this);
        }
        //if(!this.skipMoveGeneration) {
            possibleMoves = calculatePossibleMoves(this.board);
        //}
    ...
    public void showLegalMoves(ChessGameBoard board) {
        System.out.println(this.pieceColumn);
        updatePossibleMoves(board);
        if (isPieceOnScreen()) {
